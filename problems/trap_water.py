...
def test_trap_precompute():
    assert trap_precompute([0,1,0,2,1,0,1,3,2,1,2,1]) == 6
    assert trap_precompute([4,2,0,3,2,5]) == 9
    assert trap_precompute([1, 0, 2]) == 1
    assert trap_precompute([4, 1, 2]) == 1
    assert trap_precompute([1]) == 0
    assert trap_precompute([1, 1, 1, 1]) == 0


def test_trap_two_pointers():
    assert trap_two_pointers([0,1,0,2,1,0,1,3,2,1,2,1]) == 6
    assert trap_two_pointers([4,2,0,3,2,5]) == 9
    assert trap_two_pointers([1, 0, 2]) == 1
    assert trap_two_pointers([4, 1, 2]) == 1
    assert trap_two_pointers([1]) == 0
    assert trap_two_pointers([1, 1, 1, 1]) == 0
