...
def test_max_profit():
    ...
    assert max_profit_two_pointer([7, 1, 5, 3, 6, 4]) == 5
    assert max_profit_two_pointer([5, 3, 1]) == 0
    assert max_profit_two_pointer([100]) == 0
    assert max_profit_two_pointer([5, 10]) == 5
    assert max_profit_two_pointer([10, 10, 10, 10]) == 0
